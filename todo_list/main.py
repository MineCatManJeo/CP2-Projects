...
def main():
    ...
    while True:
        ...
        if error:
            print(error) # Prints an error message for the user
        error = ''
        ...
        if action == 'add':
            ...
            if len(to_do_list) > 1:
                ...
                error = 'Please add an item to the to-do list before marking items as complete!\n'
            ...
            if len(to_do_list) > 1:
                ...
                error = 'Please add an item to the to-do list before attempting to delete an item!\n'
